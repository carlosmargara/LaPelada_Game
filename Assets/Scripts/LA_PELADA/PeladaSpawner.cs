...
public class PeladaSpawner : MonoBehaviour
{
    ...
    void SpawnPelada()
    {
        ...
        Vector3 spawnPosition = player.position - player.forward * spawnDistanceBehindPlayer;// Calcula posici�n detr�s del jugador
        spawnPosition.y = player.position.y; // Asegura que est� al mismo nivel
